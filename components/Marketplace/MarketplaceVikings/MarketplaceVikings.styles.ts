...
export const MarketplaceVikingsWrapper = styled.div`
  display: flex;
...
export const MarketplaceVikingsItemsWrapper = styled.div`
  margin: 1rem;
  flex: 1 0 auto;
...
export const MarketplaceVikingsItems = styled.div`
